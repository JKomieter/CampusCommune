...
const DiscussionSidebar = () => {
    ...
    return (
        <motion.aside
            ...
            className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0 bg-blue-400">
            <div style={{ backgroundColor: "#ffffff"}} className="h-full px-3 py-4 dark:bg-gray-800 mt-14 shadow-xl overflow-y-hidden">
                <div className="mb-6 flex flex-row items-center justify-between">
                    <span className="text-lg font-semibold p-2  text-neutral-700 dark:text-white">Your Discussions</span>
                    <span onClick={() => toggleSidebar(false)} className="rounded-full p-2 hover:bg-neutral-400 cursor-pointer">
                        <IoClose size={22} className="text-neutral-700" />
                    </span>
                </div>
                <div className="space-y-2 overflow-y-scroll bg-neutral-100 h-full">
                    {
